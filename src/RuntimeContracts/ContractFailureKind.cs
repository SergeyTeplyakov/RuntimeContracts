...
{
    /// <summary>A <see cref="Contract.Requires(bool,string,string,string,int)" /> contract failed.</summary>
    Precondition,
    ...
    /// <summary>An <see cref="Contract.Assert(bool,string,string,string,int)" /> contract failed.</summary>
    Assert,
}
